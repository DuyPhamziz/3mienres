...
async function seedMore() {
  try {
    ...
    const dishesList = [
      // Món Cua
      { name: "Cua Rang Me Cà Mau", price: 350000, region: "Nam", category: catCua._id, description: "Cua Cà Mau tươi chắc thịt rang sốt me chua ngọt đậm vị Nam Bộ.", isFeatured: true, image: "/uploads/dishes/cua-rang-me-ca-mau.jpg" },
      { name: "Cua Sốt Tiêu Xanh", price: 380000, region: "Trung", category: catCua._id, description: "Cua Cà Mau sốt tiêu xanh cay nồng ấm đượm vị biển Miền Trung.", isFeatured: true, image: "/uploads/dishes/cua-sot-tieu-xanh.jpg" },
      { name: "Cua Hấp Nước Dừa Xiêm", price: 360000, region: "Nam", category: catCua._id, description: "Cua hấp nước dừa xiêm ngọt thanh tự nhiên giữ trọn vị gạch cua.", isFeatured: false, image: "/uploads/dishes/cua-hap-nuoc-dua-xiem.jpg" },
      { name: "Cua Nướng Phô Mai Béo Ngậy", price: 390000, region: "Nam", category: catNuong._id, description: "Cua nướng phủ lớp phô mai Mozzarella đút lò béo ngậy thơm lừng.", isFeatured: true, image: "/uploads/dishes/cua-nuong-pho-mai-beo-ngay.jpg" },

      // Món Lẩu
      { name: "Lẩu Cua Đồng Bắc Bộ", price: 290000, region: "Bắc", category: catLau._id, description: "Lẩu cua đồng chuẩn vị Bắc với riêu cua béo ngậy, ăn kèm rau mồng tơi và bánh đa.", isFeatured: true, image: "/uploads/dishes/lau-cua-dong-bac-bo.jpg" },
      { name: "Lẩu Thái Hải Sản Cay Nồng", price: 320000, region: "Nam", category: catLau._id, description: "Lẩu Thái chua cay đậm vị ăn kèm tôm, mực, nghêu tươi ngọt.", isFeatured: false, image: "/uploads/dishes/lau-thai-hai-san-cay-nong.jpg" },
      { name: "Lẩu Cá Kèo Lá Giang", price: 260000, region: "Nam", category: catLau._id, description: "Lẩu cá kèo lá giang vị chua thanh đậm chất miền Tây sông nước.", isFeatured: false, image: "/uploads/dishes/lau-ca-keo-la-giang.jpg" },

      // Món Nướng
      { name: "Tôm Hùm Nướng Bơ Tỏi", price: 450000, region: "Nam", category: catNuong._id, description: "Tôm hùm bông nướng sốt bơ tỏi thơm nức mũi, thịt tôm giòn ngọt.", isFeatured: true, image: "/uploads/dishes/tom-hum-nuong-bo-toi.jpg" },
      { name: "Mực Ống Nướng Sa Tế Cay", price: 220000, region: "Trung", category: catNuong._id, description: "Mực ống nướng ướp sa tế ớt hiểm cay nồng đậm vị miền Trung.", isFeatured: false, image: "/uploads/dishes/muc-ong-nuong-sa-te-cay.jpg" },
      { name: "Hàu Sữa Nướng Mỡ Hành", price: 150000, region: "Nam", category: catNuong._id, description: "Hàu sữa nướng mỡ hành béo ngậy rắc đậu phụng rang giòn.", isFeatured: false, image: "/uploads/dishes/hau-sua-nuong-mo-hanh.jpg" },
      { name: "Ốc Hương Nướng Muối Ớt", price: 240000, region: "Trung", category: catNuong._id, description: "Ốc hương nướng muối ớt cay giòn sần sật.", isFeatured: false, image: "/uploads/dishes/oc-huong-nuong-muoi-ot.jpg" },

      // Hải Sản Tươi Sống
      { name: "Ghẹ Xanh Cần Giờ Hấp Sả", price: 310000, region: "Nam", category: catHaiSan._id, description: "Ghẹ xanh thịt chắc ngọt hấp sả ớt tươi ăn kèm muối tiêu chanh.", isFeatured: false, image: "/uploads/dishes/ghe-xanh-can-gio-hap-sa.jpg" },
      { name: "Tôm Càng Xanh Hấp Bia", price: 280000, region: "Nam", category: catHaiSan._id, description: "Tôm càng xanh hấp bia thơm ngon giòn ngọt.", isFeatured: false, image: "/uploads/dishes/tom-cang-xanh-hap-bia.jpg" },
      { name: "Chả Cua Cố Đô Huế", price: 180000, region: "Trung", category: catHaiSan._id, description: "Chả cua quết dẻo thơm lừng đặc sản cố đô Huế.", isFeatured: false, image: "/uploads/dishes/cha-cua-co-do-hue.jpg" },

      // Đồ Uống & Kèm
      { name: "Bánh Mì Chấm Sốt Me", price: 25000, region: "Nam", category: catKiem._id, description: "Bánh mì giòn rụm chấm sốt me cua đậm đà.", isFeatured: false, image: "/uploads/dishes/banh-mi-cham-sot-me.jpg" },
      { name: "Bún Tươi Tẩy", price: 20000, region: "Bắc", category: catKiem._id, description: "Bún tươi ăn kèm lẩu.", isFeatured: false, image: "/uploads/dishes/bun-tuoi-tay.jpg" },
      { name: "Bia Sài Gòn Chill (Chai)", price: 28000, region: "Nam", category: catKiem._id, description: "Bia ướp lạnh sảng khoái.", isFeatured: false, image: "/uploads/dishes/bia-sai-gon-chill-chai.jpg" },
      { name: "Nước Dừa Tươi Ba Trái", price: 35000, region: "Nam", category: catKiem._id, description: "Nước dừa tươi mẻ nguyên trái.", isFeatured: false, image: "/uploads/dishes/nuoc-dua-tuoi-ba-trai.jpg" },
    ];
